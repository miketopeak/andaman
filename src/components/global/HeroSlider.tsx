          ...
          return (
            ...
            >
              <div className="relative flex items-center">
                <motion.div
                  className={cn(
                    "size-3 bg-white rounded-full relative",
                    activeIndex === index && "after:content-[''] after:absolute after:left-1/2 after:top-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:size-8 after:border after:border-[#67B6B9] after:bg-primary/30 after:rounded-full after:z-[-1]"
                  )}
                />
                <div className={cn(
                  "ml-2 text-white text-xl font-semibold transition-all duration-300",
                  activeIndex === index && "ml-6"
                )}>
                  {location.name}
                </div>
              </div>
